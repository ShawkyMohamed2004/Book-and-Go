...
function bookRoom(roomCard) {
    ...
    const roomImageSrc = roomCard.querySelector('.room-image img').getAttribute('src');
    const roomImageName = roomImageSrc.split('/').pop();
    ...
    const hotelName = 'Lilas Blanc Hotel';
    
    const bookingDetails = {
        hotel: hotelName,
        roomType: roomType,
        roomImage: '../assets/images/' + roomImageName,
        checkIn: checkIn,
        checkOut: checkOut,
        adults: adults,
        children: children,
